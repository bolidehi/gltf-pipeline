...
const compressGltfpack = require('./compressGltfpack');
 ...
 * @param {Object} [options.gltfpackOptions] Options to pass to the compressGltfpack stage. If undefined, stage is not run.
...
function getStages(options) {
    ...
    if (defined(options.gltfpackOptions)) {
        stages.push(compressGltfpack);
    }
...
processGltf.defaults = {
    ...
    /**
     * Gets or sets whether to compress the meshes using gltfpack. Adds the KHR_mesh_quantization extension.
     * @type Boolean
     * @default false
     */
    compressGltfpack: false
};
