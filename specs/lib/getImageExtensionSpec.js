...
const tiffLsbData = dataUriToBuffer(
  "data:application/octet-stream;base64,"
);

const tiffMsbData = dataUriToBuffer(
  "data:application/octet-stream;base64,"
);
...
describe("getImageExtension", () => {
  it("gets image extension from buffer", () => {
    ...
    expect(getImageExtension(tiffLsbData)).toBe(".tiff");
    expect(getImageExtension(tiffMsbData)).toBe(".tiff");
  });
